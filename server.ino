...
const char* device_token  = "6593040ff007ad74";
const char* fingerprint = "09:60:E7:EE:66:3A:8A:20:9C:09:EF:27:A8:F7:A2:66:4B:A0:C2:53";
String URL = "https://adsmstech.tech/getdata.php";
String getData, Link;
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  digitalWrite(ON_Board_LED, HIGH);
    ...
    WiFiClient client;
     const char * host = "192.168.1.50";            //default IP address
